!function(){let e="cookie_consent";function t(t){localStorage.setItem(e,JSON.stringify({accepted:t,version:"1",timestamp:new Date().toISOString()}))}function n(){if(null!==function(){let t=localStorage.getItem(e);if(!t)return null;try{let e=JSON.parse(t);if("1"!==e.version)return null;return e.accepted}catch{return null}}())return;let n=function(){let e=document.createElement("div");return e.id="cookieConsentBanner",e.className="cookie-consent-banner",e.setAttribute("role","dialog"),e.setAttribute("aria-label","Cookie consent"),e.innerHTML=`
...
//# sourceMappingURL=index.103a6b67.js.map
