...
`;class tM extends HTMLElement{#t=null;#e;#o;#i;#n;constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(tN.content.cloneNode(!0))),this.#e=this.shadowRoot.querySelector("button"),this.#o=this.shadowRoot.querySelector('slot[name="copy"]'),this.#i=this.shadowRoot.querySelector('slot[name="success"]'),this.#n=this.shadowRoot.querySelector('slot[name="error"]')}static get observedAttributes(){return["disabled"]}connectedCallback(){this.#r("value"),this.#r("from"),this.#r("disabled"),this.#r("feedbackDuration"),this.#e.addEventListener("click",this.#l)}disconnectedCallback(){this.#e.removeEventListener("click",this.#l),this.#s()}attributeChangedCallback(t){"disabled"===t&&(this.#e.disabled=this.disabled,this.#e.setAttribute("aria-disabled",this.disabled.toString()),this.#e.part.contains("button")&&this.#e.part.toggle("button--disabled",this.disabled))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}get from(){return this.getAttribute("from")}set from(t){this.setAttribute("from",t)}get disabled(){return this.hasAttribute("disabled")}set disabled(t){t?this.setAttribute("disabled",""):this.removeAttribute("disabled")}get feedbackDuration(){return Number(this.getAttribute("feedback-duration"))||1e3}set feedbackDuration(t){this.setAttribute("feedback-duration",t)}async #a(){if(this.value||this.from)try{let t="";if(this.value)t=this.value;else if(this.from){let e="getRootNode"in Element.prototype?this.#e.getRootNode({composed:!0}):this.#e.ownerDocument;if(!e||!(e instanceof Document||e instanceof ShadowRoot))return;let i=e.querySelector(this.from);if(!i)return;t=i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement?i.value:i instanceof HTMLAnchorElement&&i.hasAttribute("href")?i.href:i.textContent}await navigator.clipboard.writeText(t),this.#c(t_),this.dispatchEvent(new CustomEvent(`${tL}-success`,{bubbles:!0,composed:!0,detail:{value:t}}))}catch(t){this.#c(tR),this.dispatchEvent(new CustomEvent(`${tL}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}#l=t=>{t.preventDefault(),this.disabled||this.#t||this.#a()};#c(t){this.#o.hidden=!0,this.#i.hidden=t!==t_,this.#n.hidden=t!==tR,this.#e.part.remove("button--success"),this.#e.part.remove("button--error"),this.#e.part.add(`button--${t}`),this.#t&&clearTimeout(this.#t),this.#t=setTimeout(()=>{this.#o.hidden=!1,this.#i.hidden=!0,this.#n.hidden=!0,this.#e.part.remove(`button--${t}`),this.#t=null},this.feedbackDuration)}#s(){this.#t&&clearTimeout(this.#t),this.#t=null,this.#o.hidden=!1,this.#i.hidden=!0,this.#n.hidden=!0,this.#e.part.remove("button--success"),this.#e.part.remove("button--error")}#r(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t=tL){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tM)}}class tO extends tM{constructor(){super();let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]');t.innerHTML=`
    ...
    `}static get observedAttributes(){return[...super.observedAttributes,"only-icon"]}attributeChangedCallback(t,e,i){if(super.attributeChangedCallback(t,e,i),"only-icon"===t&&e!==i){let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]'),i=t.querySelector(".text"),o=e.querySelector(".text");i&&(i.hidden=this.onlyIcon),o&&(o.hidden=this.onlyIcon)}}get onlyIcon(){return this.hasAttribute("only-icon")}set onlyIcon(t){t?this.setAttribute("only-icon",""):this.removeAttribute("only-icon")}connectedCallback(){super.connectedCallback(),this.#C("onlyIcon"),this.hasAttribute("feedback-duration")||this.setAttribute("feedback-duration","1500")}disconnectedCallback(){super.disconnectedCallback()}#C(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="custom-clipboard-copy"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tO)}}tO.defineCustomElement(),async function(){let t,e;let i="No barcode detected",o=document.querySelector("a-tab-group"),s=document.getElementById("cameraPanel"),n=document.querySelector("capture-photo"),r=document.getElementById("cameraResults"),l=document.getElementById("fileResults"),d=document.getElementById("scanInstructions"),c=document.getElementById("scanBtn"),h=document.getElementById("dropzone"),u=document.querySelector("resize-observer"),p=document.getElementById("scanFrame"),b=document.getElementById("globalActions"),m=document.getElementById("historyBtn"),g=document.getElementById("historyDialog"),f=document.getElementById("historyList"),v=document.getElementById("deleteHistoryBtn"),w=document.getElementById("settingsBtn"),y=document.getElementById("settingsDialog"),E=document.forms["settings-form"],A=document.getElementById("supportedFormats"),x=!0;if(!("BarcodeDetector"in window))try{await a("1OZCQ")}catch(t){return b.hidden=!0,o.style.display="none",tS("BarcodeDetector API is not supported by your browser.","danger")}H()||document.querySelectorAll("web-share").forEach(t=>{t.hidden=!0,t.disabled=!0});let{value:z=[]}=await tx();_(z),n.addEventListener("capture-photo:video-play",t=>{p.hidden=!1,q(t.detail.video),e=t.detail.video||n.shadowRoot?.querySelector("video"),B();let i=n.getTrackSettings(),o=n.getTrackCapabilities(),s=document.getElementById("zoomLevel");if(i?.zoom&&o?.zoom){let t=document.getElementById("zoomControls"),e=o?.zoom?.min||0,a=o?.zoom?.max||10,r=i?.zoom||1;t.hidden=!1,s.textContent=r,t.addEventListener("click",t=>{let i=t.target.closest('[data-action="zoom-in"]'),o=t.target.closest('[data-action="zoom-out"]');i&&r<a&&(r+=.5),o&&r>e&&(r-=.5),s.textContent=r,n.zoom=r})}},{once:!0}),n.addEventListener("capture-photo:error",t=>{let e=t.detail.error;if("NotFoundError"===e.name)return;let i="NotAllowedError"===e.name?"Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;s.innerHTML=`<div class="alert alert-danger" role="alert" style="margin: 0;">${i}</div>`},{once:!0}),tp.defineCustomElement(),h.accept="image/jpg,image/jpeg,image/png,image/apng,image/gif,image/webp,image/avif";let k=()=>(e||(e=n.shadowRoot?.querySelector("video")),e),C=await window.BarcodeDetector.getSupportedFormats(),S=new window.BarcodeDetector({formats:C}),{value:T={}}=await tE();Object.entries(T).forEach(([t,e])=>{let i=E.querySelector(`[name="${t}"]`);i&&(i.checked=e)}),Array.isArray(C)&&C.length>0&&(A.textContent=`Supported formats: ${C.join(", ")}`);let L=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return async(e,i,o,s,a)=>{let{value:n}=await tE();if(!n?.beep)return;let r=t.createOscillator(),l=t.createGain();r.connect(l),l.connect(t.destination),o&&(l.gain.value=o),i&&(r.frequency.value=i),s&&(r.type=s),"function"==typeof a&&(r.onended=a),r.start(t.currentTime),r.stop(t.currentTime+(e||500)/1e3)}})();function _(t){f.innerHTML="",Array.isArray(t)&&t.length?(v.style.display="block",t.forEach(t=>{let e;let i=document.createElement("li");i.setAttribute("data-value",t);try{new URL(t),(e=document.createElement("a")).href=t,e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")}catch(t){e=document.createElement("span")}e.textContent=t,e.setAttribute("title",t);let o=document.createElement("div");o.className="history-modal__actions";let s=document.createElement("custom-clipboard-copy");s.title="Copy to clipboard",s.setAttribute("only-icon",""),s.setAttribute("value",t),o.appendChild(s);let a=document.createElement("button");a.type="button",a.className="history-modal__delete-action",a.title="Remove from history",a.setAttribute("data-action","delete"),a.innerHTML=`
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
            <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
          </svg>
        `,o.appendChild(a),i.appendChild(e),i.appendChild(o),f.appendChild(i)})):(f.innerHTML="<li class=>There are no saved items in history.</li>",v.style.display="none")}async function R(t){let{value:e}=await tE();if(!t||!e?.addToHistory)return;let{value:i=[],error:o}=await tx();if(!o&&!i.find(e=>e===t)){let e=[...i,t],{error:o}=await tz(e);o||_(e)}}async function N(t){if(!t)return;let{value:e=[],error:i}=await tx();if(!i){let i=e.filter(e=>e!==t),{error:o}=await tz(i);o||_(i)}}async function M(){let{error:t}=await tz([]);t||_([])}async function O(t=100){let{value:e}=await tE();if("function"==typeof window.navigator.vibrate&&e?.vibrate)try{window.navigator.vibrate(t)}catch{}}function q(t){if(!t)return;let e=t.getBoundingClientRect();p.style.cssText=`width: ${e.width}px; height: ${e.height}px`}function I(t){t?.querySelector(".results__item")?.remove()}async function D(t,e){let o;if(!t||!e){console.error("createResult: missing value or resultDialog");return}I(e);try{let{value:e}=await tE();new URL(t),(o=document.createElement("a")).href=t,e?.openWebPageSameTab||(o.setAttribute("target","_blank"),o.setAttribute("rel","noreferrer noopener")),e?.openWebPage&&o.click()}catch(t){o=document.createElement("span")}o.className="results__item",o.classList.toggle("results__item--no-barcode",t===i),o.textContent=t,e.insertBefore(o,e.querySelector(".results__actions"));let s=e.querySelector("custom-clipboard-copy"),a=e.querySelector("web-share"),n=t!==i;s&&(s.disabled=!n,s.hidden=!n),a&&H()&&(a.disabled=!n,a.hidden=!n,n?a.setAttribute("share-text",t):a.removeAttribute("share-text")),e.show()}function $(t){return new Promise((e,i)=>{S.detect(t).then(t=>{Array.isArray(t)&&t.length>0?e(t[0]):i({message:"Could not detect barcode from provided source."})}).catch(t=>{i(t)})})}async function B(){d.hidden=!1;try{let e={},i=k();if(!i){console.error("Video element not found in scan()"),x&&(t=window.requestAnimationFrame(()=>B()));return}if(i.readyState<2){x&&(t=window.requestAnimationFrame(()=>B()));return}if(!(e=await $(i))||!e.rawValue)throw Error("No rawValue in detected barcode");console.log("✓ Barcode detected:",e.rawValue),window.cancelAnimationFrame(t),I(r),D(e.rawValue,r),R(e.rawValue),d.hidden=!0,c.hidden=!1,p.hidden=!0,L(200,860,.03,"square"),O();return}catch(t){}x&&(t=window.requestAnimationFrame(()=>B()))}c.addEventListener("click",()=>{c.hidden=!0,p.hidden=!1,I(r),r.close(),B()}),o.addEventListener("a-tab-show",tT(t=>{let e=t.detail.tabId;if("cameraTab"===e){x=!0;let t=document.querySelector("capture-photo");!t||t.loading||r.querySelector(".results__item")||B(),null!=t&&"function"==typeof t.startVideoStream&&t.startVideoStream()}"fileTab"===e&&(x=!1,null!=n&&"function"==typeof n.stopVideoStream&&n.stopVideoStream())},250)),h.addEventListener("files-dropzone-drop",t=>{!function(t){if(!t)return;let e=new Image,o=new FileReader;o.onload=o=>{let s=o.target.result;e.onload=async()=>{try{let t=await $(e);I(l),D(t.rawValue,l),R(t.rawValue),L(200,860,.03,"square"),O()}catch(t){I(l),D(i,l)}},e.src=s,h.replaceChildren();let a=document.createElement("div");a.className="dropzone-preview";let n=document.createElement("div");n.className="dropzone-preview__image-wrapper";let r=document.createElement("div");r.className="dropzone-preview__file-name",r.textContent=t.name,n.appendChild(e),a.appendChild(n),a.appendChild(r),h.prepend(a)},o.readAsDataURL(t)}(t.detail.acceptedFiles[0])}),u.addEventListener("resize-observer:resize",()=>{q(n.shadowRoot.querySelector("video"))}),w.addEventListener("click",()=>{y.showModal()}),m.addEventListener("click",()=>{g.showModal()}),g.addEventListener("click",t=>{t.target===t.currentTarget&&g.close()}),y.addEventListener("click",t=>{t.target===t.currentTarget&&y.close()}),E.addEventListener("change",t=>{let e={};t.currentTarget.querySelectorAll('input[type="checkbox"]').forEach(t=>e[t.name]=t.checked),tA(e)}),f.addEventListener("click",t=>{let e=t.target;e.closest('[data-action="delete"]')&&window.confirm("Delete item from history?")&&N(e.closest("li").dataset.value)}),v.addEventListener("click",()=>{window.confirm("Are you sure you want to empty history?")&&M()})}();
//# sourceMappingURL=scanner.6eeb6db2.js.map
